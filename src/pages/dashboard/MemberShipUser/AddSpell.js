...
import { Card, Grid, Stack, Typography, Container, Box,TextField,MenuItem } from '@mui/material';
...
import { FormProvider, RHFTextField, RHFDescription, RHFSelect,RHFUploadAvatar } from '../../../components/hook-form';
...
export default function AddTag() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // provider.append('speciality_id', data?.specialities);
      ...
      // provider.append('website', data?.website);

      console.log(provider);
      await axios
        .post('/api/admin/post', provider)

        .then((response) => {
          console.log(response);
          if (response?.data?.message === 'Post Upload Successfully') {
  ...
  return (
    <Container maxWidth="xl">
      <HeaderBreadcrumbs heading="Add Post" links={[{ name: '', href: '' }]} />
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={8}>
            <Card sx={{ p: 3 }}>
              ...
              >
                <RHFTextField name="fname" label="User Name" InputLabelProps={{ shrink: true }} />
                <RHFTextField name="lname" label="Post Ttile" InputLabelProps={{ shrink: true }} />
                ...
                {/* <RHFTextField name="zipCode" label="ZIP Code" InputLabelProps={{ shrink: true }} /> */}
                ...
                <TextField
                  ...
                  sx={{ gridColumn: { sm: 'span 1' } }}
                 />
                <RHFTextField name="slotDuration" label="Slot Duration (in Minute)"  InputLabelProps={{ shrink: true }} />
                <RHFSelect
                name='specialities'
              ...
              {/* <Grid item xs={12} md={12} sx={{ pt: 2 }}>
                <div>
                  <RHFDescription name="address" label="Address" multiline rows={3}  InputLabelProps={{ shrink: true }}/>
                </div>
              </Grid> */}
